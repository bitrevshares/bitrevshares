...
#if defined(NDEBUG)
# error "BitRevShares cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BitRevShares Signed Message:\n";
...
static const int64_t nBlockRewardIcoCoin = 1000000 * COIN;
static const int64_t nBlockRewardCoin = 3.5 * COIN;
static const int64_t nEndBlockRewardCoin = 1 * COIN;
...
int64_t GetBlockValue(int nHeight, int64_t nFees)
{
    ...
    {
        return nEndBlockRewardCoin + nFees;
    }
}
